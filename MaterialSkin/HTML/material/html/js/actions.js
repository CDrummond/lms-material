...
function updateActionStrings() {
    ...
    ACTIONS[PQ_CLEAR_PLAYED_ACTION].title=i18n("Remove played tracks");
    ACTIONS[PQ_CLEAR_UPCOMMING_ACTION].title=i18n("Clear upcoming");
}
