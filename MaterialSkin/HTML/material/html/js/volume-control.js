...
<v-layout row wrap :class="'vol-control-'+layout">
 ...
 <v-flex :disabled="VOL_HIDDEN==dvc" xs12>
  <v-layout>
   ...
   <p v-if="layout==1" class="vol-full-label link-item" v-bind:class="{'disabled':noPlayer,'dimmed':muted,'pulse':!noPlayer && value==0 && playing}" @click.middle="toggleMute" v-longpress="toggleMuteLabel" id="vol-label">{{value|displayVal(dvc)}}</p>
