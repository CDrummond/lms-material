...
const LMS_CACHE_VERSION = 630;
const LMS_LIST_ELEMENT_SIZE = 48;
const LMS_LIST_3LINE_ELEMENT_SIZE = 70;
const LMS_ALBUM_QUEUE_HEADER = 68;
const LMS_GROUP_QUEUE_HEADER = 82; // Group header has 2 lines before track - album name/group name
const LMS_WORK_QUEUE_HEADER = 96;  // Work header has 3 lines
const LMS_ALBUM_QUEUE_TRACK = 35;
