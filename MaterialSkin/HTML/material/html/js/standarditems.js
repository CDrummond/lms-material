...
const STD_ITEMS=[
    ...
    },
    {
        ...
        actionMenu: [/*SEARCH_LIST_ACTION, DIVIDER, */INSERT_ACTION, PLAY_SHUFFLE_ACTION, DIVIDER, SCROLL_TO_DISC_ACTION, ADD_TO_FAV_ACTION, ADD_TO_PLAYLIST_ACTION, DOWNLOAD_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION],
    ...
    },
    {
        ...
        actionMenu: [/*SEARCH_LIST_ACTION, DIVIDER,*/ INSERT_ACTION, PLAY_SHUFFLE_ACTION, DIVIDER, ADD_TO_FAV_ACTION, REMOVE_DUPES_ACTION, PLAYLIST_SORT_ACTION, DOWNLOAD_ACTION, MORE_LIB_ACTION]
    },
    {
        command: ["playlists", "tracks"],
        params: [PLAYLIST_TRACK_TAGS], // "tags:IRad"] -> Will show rating, not album???
        menu: [/*SEARCH_LIST_ACTION, DIVIDER, */PLAY_ACTION, INSERT_ACTION, ADD_ACTION, DIVIDER, ADD_TO_FAV_ACTION, SELECT_ACTION]
    },
    {
        command: ["albums"],
