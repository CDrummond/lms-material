 ...
 <v-card>
  ...
  <div class="ios-vcard-text-workaround"><div class="infodetails" id="info-page">
   ...
   <ul>
    ...
    <li v-if="scanning"><v-icon class="spinner">refresh</v-icon> {{scanInfo}}</li>
   ...
   <p v-if="'downloading'==pluginStatus"><v-icon class="spinner">autorenew</v-icon> {{i18n('Downloading plugin updates')}}</p>
