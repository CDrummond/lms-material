            ...
            if (data.result.contributors_loop && data.result.contributors_count>0) {
                ...
                data.result.contributors_loop.forEach(i => {
                    resp.items.push({
                                  ...
                                  actions: [PLAY_ACTION, ADD_ACTION, ADD_RANDOM_ALBUM_ACTION, ADD_TO_FAV_ACTION],
                                  type: "group"
                              });
                });
            }
            if (data.result.albums_loop && data.result.albums_count>0) {
                ...
                data.result.albums_loop.forEach(i => {
                    resp.items.push({
                                  ...
                                  actions: [PLAY_ACTION, ADD_ACTION, ADD_TO_FAV_ACTION],
                                  type: "group"
                              });
                });
            }
            ...
            if (data.result.artists_loop) {
                ...
                data.result.playlists_loop.forEach(i => {
                    resp.items.push({
                                  ...
                                  actions: [PLAY_ACTION, ADD_ACTION, ADD_TO_FAV_ACTION, RENAME_PL_ACTION, DELETE_ACTION],
                                  type: "group"
                              });
                });
                    ...
                    if ("text"===i.type || "textarea"===i.type) {
                        ...
                        resp.items.push({
                                      ...
                                      actions: "favorites"===parent.type 
                                                    ? topLevelFavourites
                                                        ? [PLAY_ACTION, ADD_ACTION, RENAME_FAV_ACTION, REMOVE_FROM_FAV_ACTION]
                                                        : [PLAY_ACTION, ADD_ACTION, REMOVE_FROM_FAV_ACTION]
                                                    : i.isaudio === 1
                                                        ? [PLAY_ACTION, ADD_ACTION, ADD_TO_FAV_ACTION]
                                                        : undefined,
                                      id: "item_id:"+i.id
                                   });
                    } else if (i.isaudio === 1) {
                        resp.items.push({
                                      ...
                                      actions: topLevelFavourites
                                                    ? [PLAY_ACTION, ADD_ACTION, RENAME_FAV_ACTION, REMOVE_FROM_FAV_ACTION]
                                                    : [PLAY_ACTION, ADD_ACTION, "favorites"===parent.type ? REMOVE_FROM_FAV_ACTION : ADD_TO_FAV_ACTION],
                                      app: parent.app,
                                      id: "item_id:"+i.id
                                   });
