...
sub prefs {
    return ($prefs, qw(composergenres conductorgenres bandgenres maiComposer showComposer showConductor showBand showArtistWorks password respectFixedVol showAllArtists artistFirst allowDownload commentAsDiscTitle showComment pagedBatchSize noArtistFilter releaseTypeOrder genreImages playlistImages touchLinks yearInSub playShuffle combineAppsAndRadio hidePlayers screensaverTimeout npSwitchTimeout useDefaultForSettings useGrouping setPlayerLibrary groupCategories));
}
