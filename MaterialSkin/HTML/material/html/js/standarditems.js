...
const STD_ITEM_MAI = 100;
const STD_ITEM_MIX = 101;
const STD_ITEM_ALL_TRACKS = 102;
const STD_ITEM_COMPOSITION_TRACKS = 103;
...
const STD_ITEMS=[
    ...
    },
    {
        ...
        actionMenu: [DIVIDER, INSERT_ACTION, DIVIDER, SCROLL_TO_DISC_ACTION, ADD_TO_FAV_ACTION, ADD_TO_PLAYLIST_ACTION, DOWNLOAD_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION],
