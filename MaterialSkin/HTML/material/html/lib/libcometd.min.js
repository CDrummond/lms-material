...
!0;var d="Request "+b.id+" of transport "+g.getType()+" exceeded "+e+" ms max network delay",q={reason:d},k=b.xhr;q.httpCode=g.xhrStatus(k);g.abortXHR(k);g._debug(d);g.complete(b,!1,b.metaConnect);c.onFailure(k,c.messages,q)},e)}}function c(c){var b=++m,g={id:b,metaConnect:!1,envelope:c};v.length<this.getConfiguration().maxConnections-1?(v.push(g),d.call(this,c,g)):(this._debug("Transport",this.getType(),"queueing request",b,"envelope",c),y.push([c,g]))}function g(d,g){var e=l.inArray(d,v);0<=e&&
v.splice(e,1);if(0<y.length){e=y.shift();var k=e[0],q=e[1];this._debug("Transport dequeued request",q.id);if(g)this.getConfiguration().autoBatch&&b.call(this,k),c.call(this,k),this._debug("Transport completed request",d.id,k);else{var u=this;this.setTimeout(function(){u.complete(q,!1,q.metaConnect);var c={reason:"Previous request failed"},b=q.xhr;c.httpCode=u.xhrStatus(b);k.onFailure(b,k.messages,c)},0)}}}var e=new w,k=w.derive(e),m=0,n=null,v=[],y=[];k.complete=function(c,b,d){if(d){c=c.id;this._debug("Transport",
...
(a=window.console[a],c(a))){var b=new Date;[].splice.call(f,0,0,g(b.getHours(),2)+":"+g(b.getMinutes(),2)+":"+g(b.getSeconds(),2)+"."+g(b.getMilliseconds(),3));a.apply(window.console,f)}}function k(a){return/(^https?:\/\/)?(((\[[^\]]+])|([^:/?#]+))(:(\d+))?)?([^?#]*)(.*)?/.exec(a)}function w(a){h._debug("Configuring cometd object with",a);l.isString(a)&&(a={url:a});a||(a={});r=h._mixin(!1,r,a);a=h.getURL();if(!a)throw"Missing required configuration parameter 'url' specifying the Bayeux server URL";
var f=k(a);a=f[8];var c=f[9];Y=h._isCrossDomain(f[2]);r.appendMessageTypeToURL&&(void 0!==c&&0<c.length?(h._info("Appending message type to URI "+a+c+" is not supported, disabling 'appendMessageTypeToURL' configuration"),r.appendMessageTypeToURL=!1):(f=a.split("/"),c=f.length-1,a.match(/\/$/)&&--c,0<=f[c].indexOf(".")&&(h._info("Appending message type to URI "+a+" is not supported, disabling 'appendMessageTypeToURL' configuration"),r.appendMessageTypeToURL=!1)));if(window.Worker&&window.Blob&&window.URL&&
r.useWorkerScheduler){a=e.toString();a=a.substring(a.indexOf("{")+1,a.lastIndexOf("}"));a=new window.Blob([a],{type:"application/json"});a=window.URL.createObjectURL(a);var b=new window.Worker(a);J.setTimeout=function(a,f){a=J.register(a);b.postMessage({id:a,type:"setTimeout",delay:f});return a};J.clearTimeout=function(a){J.unregister(a);b.postMessage({id:a,type:"clearTimeout"})};b.onmessage=function(a){(a=J.unregister(a.data.id))&&a()}}}function n(a){if(a){var f=G[a.channel];f&&f[a.id]&&(delete f[a.id],
h._debug("Removed",a.listener?"listener":"subscription",a))}}function v(){for(var a in G)if(G.hasOwnProperty(a)){var f=G[a];if(f)for(var c in f)if(f.hasOwnProperty(c)){var b=f[c];b&&!b.listener&&n(b)}}}function y(a){L!==a&&(h._debug("Status",L,"->",a),L=a)}function q(){return"disconnecting"===L||"disconnected"===L}function D(a,f,b,z,d){try{return f.call(a,z)}catch(K){a=h.onExtensionException;if(c(a)){h._debug("Invoking extension exception handler",b,K);try{a.call(h,K,b,d,z)}catch(ea){h._info("Exception during execution of extension exception handler",
...
(delete Z[t],a.splice(b--,1))}0!==a.length&&(b=h.getURL(),r.appendMessageTypeToURL&&(b.match(/\/$/)||(b+="/"),c&&(b+=c)),a={url:b,sync:!1,messages:a,onSuccess:function(a){try{Fa.call(h,a)}catch(Ga){h._info("Exception during handling of messages",Ga)}},onFailure:function(a,f,c){try{var b=h.getTransport();c.connectionType=b?b.getType():"unknown";na.call(h,a,f,c)}catch(Ha){h._info("Exception during handling of failure",Ha)}}},h._debug("Send",a),p.send(a,f))}function T(a){0<I||!0===V?Q.push(a):S([a],
!1)}function oa(){var a=Q;Q=[];0<a.length&&S(a,!1)}function aa(a){y("connecting");ma(function(){if(!q()){var a={id:""+ ++N,channel:"/meta/connect",connectionType:p.getType()};ba||(a.advice={timeout:0});y("connecting");h._debug("Connect sent",a);S([a],!0,"connect");y("connected")}},a)}function pa(a){a&&(A=h._mixin(!1,{},r.advice,a),h._debug("New advice",A))}function W(a){null!==M&&h.clearTimeout(M);M=null;a&&p&&p.abort();Y=!1;p=null;y("disconnected");P=null;E=I=0;ba=fa=!1;X=0;0<Q.length&&(a=Q,Q=[],
na.call(h,void 0,a,{reason:"Disconnected"}))}function ha(a,f,b){var d=h.onTransportException;if(c(d)){h._debug("Invoking transport exception handler",a,f,b);try{d.call(h,b,a,f)}catch(Ea){h._info("Exception during execution of transport exception handler",Ea)}}}function qa(a,f){c(a)&&(f=a,a=void 0);P=null;v();q()&&F.reset(!0);pa({});I=0;V=!0;ia=a;ra=f;a=h.getURL();var b=F.findTransportTypes("1.0",Y,a),d={id:""+ ++N,version:"1.0",minimumVersion:"1.0",channel:"/meta/handshake",supportedConnectionTypes:b,
advice:{timeout:A.timeout,interval:A.interval}};d=h._mixin(!1,{},ia,d);h._putCallback(d.id,f);if(!p&&(p=F.negotiateTransport(b,"1.0",Y,a),!p))throw f="Could not find initial transport among: "+F.getTransportTypes(),h._warn(f),f;h._debug("Initial transport is",p.getType());y("handshaking");h._debug("Handshake sent",d);S([d],!1,"handshake")}function da(a){y("handshaking");V=!0;ma(function(){qa(ia,ra)},a)}function sa(a,f){try{a.call(h,f)}catch(t){if(a=h.onCallbackException,c(a)){h._debug("Invoking callback exception handler",
t);try{a.call(h,t,f)}catch(z){h._info("Exception during execution of callback exception handler",z)}}else h._info("Exception during execution of message callback",t)}}function H(a){var f=h._getCallback([a.id]);c(f)&&(delete Z[a.id],sa(f,a))}function ta(a){var f=ja[a.id];delete ja[a.id];if(f){h._debug("Handling remote call response for",a,"with context",f);var b=f.timeout;b&&h.clearTimeout(b);f=f.callback;if(c(f))return sa(f,a),!0}return!1}function ua(a){h._debug("Transport failure handling",a);a.transport&&
(p=a.transport);a.url&&p.setURL(a.url);var f=a.action;a=a.delay||0;switch(f){case "handshake":da(a);break;case "retry":aa(a);break;case "none":W(!0);break;default:throw"Unknown action "+f;}}function ka(a,f){H(a);x("/meta/handshake",a);x("/meta/unsuccessful",a);q()&&(f.action="none");h.onTransportFailure.call(h,a,f,ua)}function va(a,f){x("/meta/connect",a);x("/meta/unsuccessful",a);q()&&(f.action="none");h.onTransportFailure.call(h,a,f,ua)}function wa(a){W(!0);H(a);x("/meta/disconnect",a);x("/meta/unsuccessful",
a)}function xa(a){var f=G[a.subscription];if(f)for(var b in f)if(f.hasOwnProperty(b)){var c=f[b];c&&!c.listener&&(delete f[b],h._debug("Removed failed subscription",c))}H(a);x("/meta/subscribe",a);x("/meta/unsuccessful",a)}function ya(a){H(a);x("/meta/unsubscribe",a);x("/meta/unsuccessful",a)}function la(a){ta(a)||(H(a),x("/meta/publish",a),x("/meta/unsuccessful",a))}function za(a){for(var b=X=0;b<B.length&&void 0!==a&&null!==a;++b){var d=B[b],e=d.extension.incoming;c(e)&&(d=D(d.extension,e,d.name,
a,!1),a=void 0===d?a:d)}if(void 0!==a&&null!==a)switch(pa(a.advice),a.channel){case "/meta/handshake":b=h.getURL();if(a.successful)if(d=h._isCrossDomain(k(b)[2]),b=F.negotiateTransport(a.supportedConnectionTypes,a.version,d,b),null===b)a.successful=!1,ka(a,{cause:"negotiation",action:"none",transport:null});else switch(p!==b&&(h._debug("Transport",p.getType(),"->",b.getType()),p=b),P=a.clientId,V=!1,oa(),a.reestablish=fa,fa=!0,H(a),x("/meta/handshake",a),R=a["x-messages"]||0,a=q()?"none":A.reconnect||
"retry",a){case "retry":E=0;0===R?aa(0):h._debug("Processing",R,"handshake-delivered messages");break;case "none":W(!0);break;default:throw"Unrecognized advice action "+a;}else ka(a,{cause:"unsuccessful",action:A.reconnect||"handshake",transport:p});break;case "/meta/connect":if(ba=a.successful)switch(x("/meta/connect",a),a=q()?"none":A.reconnect||"retry",a){case "retry":E=0;aa(E);break;case "none":W(!1);break;default:throw"Unrecognized advice action "+a;}else va(a,{cause:"unsuccessful",action:A.reconnect||
"retry",transport:p});break;case "/meta/disconnect":a.successful?(W(!1),H(a),x("/meta/disconnect",a)):wa(a);break;case "/meta/subscribe":a.successful?(H(a),x("/meta/subscribe",a)):xa(a);break;case "/meta/unsubscribe":a.successful?(H(a),x("/meta/unsubscribe",a)):ya(a);break;default:void 0!==a.data?ta(a)||(x(a.channel,a),0<R&&(--R,0===R&&(h._debug("Processed last handshake-delivered message"),aa(0)))):void 0===a.successful?h._warn("Unknown Bayeux Message",a):a.successful?(H(a),x("/meta/publish",a)):
la(a)}}function Aa(a,b){var f={scope:a,method:b};if(c(a))f.scope=void 0,f.method=a;else if(l.isString(b)){if(!a)throw"Invalid scope "+a;f.method=a[b];if(!c(f.method))throw"Invalid callback "+b+" for scope "+a;}else if(!c(b))throw"Invalid callback "+b;return f}function Ba(a,b,c,d){c=Aa(b,c);h._debug("Adding",d?"listener":"subscription","on",a,"with scope",c.scope,"and callback",c.method);b=++Ia;c={id:b,channel:a,scope:c.scope,callback:c.method,listener:d};var f=G[a];f||(f={},G[a]=f);f[b]=c;h._debug("Added",
d?"listener":"subscription",c);return c}var J=new m,h=this,Ja=b||"default",Y=!1,F=new C,p,L="disconnected",N=0,P=null,I=0,Q=[],V=!1,Ia=0,G={},E=0,M=null,B=[],A={},ia,ra,Z={},ja={},fa=!1,ba=!1,X=0,R=0,r={useWorkerScheduler:!0,protocol:null,stickyReconnect:!0,connectTimeout:0,maxConnections:2,backoffIncrement:1E3,maxBackoff:6E4,logLevel:"info",maxNetworkDelay:1E4,requestHeaders:{},appendMessageTypeToURL:!0,autoBatch:!1,urls:{},maxURILength:2E3,advice:{timeout:6E4,interval:0,reconnect:void 0,maxInterval:0}};
this._mixin=function(a,b,c){for(var f=b||{},e=2;e<arguments.length;++e){var h=arguments[e];if(void 0!==h&&null!==h)for(var t in h)if(h.hasOwnProperty(t)){var g=d(h,t),k=d(f,t);g!==b&&void 0!==g&&(f[t]=a&&"object"===typeof g&&null!==g?g instanceof Array?this._mixin(a,k instanceof Array?k:[],g):this._mixin(a,"object"!==typeof k||k instanceof Array?{}:k,g):g)}}return f};this._warn=function(){u("warn",arguments)};this._info=function(){"warn"!==r.logLevel&&u("info",arguments)};this._debug=function(){"debug"===
r.logLevel&&u("debug",arguments)};this._isCrossDomain=function(a){return window.location&&window.location.host&&a?a!==window.location.host:!1};this.send=T;this._getCallback=function(a){return Z[a]};this._putCallback=function(a,b){var f=this._getCallback(a);c(b)&&(Z[a]=b);return f};this.onTransportFailure=function(a,b,c){this._debug("Transport failure",b,"for",a);var f=this.getTransportRegistry(),d=this.getURL(),e=this._isCrossDomain(k(d)[2]),g=f.findTransportTypes("1.0",e,d);"none"===b.action?"/meta/handshake"!==
a.channel||b.transport||(f="Could not negotiate transport, client=["+g+"], server=["+a.supportedConnectionTypes+"]",this._warn(f),ha(p.getType(),null,{reason:f,connectionType:p.getType(),transport:p})):(b.delay=this.getBackoffPeriod(),"/meta/handshake"===a.channel?(b.transport||((f=f.negotiateTransport(g,"1.0",e,d))?(this._debug("Transport",p.getType(),"->",f.getType()),ha(p.getType(),f.getType(),a.failure),b.action="handshake",b.transport=f):(this._warn("Could not negotiate transport, client=["+
g+"]"),ha(p.getType(),null,a.failure),b.action="none")),"none"!==b.action&&this.increaseBackoffPeriod()):(a=(new Date).getTime(),0===X&&(X=a),"retry"===b.action&&(b.delay=this.increaseBackoffPeriod(),g=A.maxInterval,0<g&&a-X+E>A.timeout+A.interval+g&&(b.action="handshake")),"handshake"===b.action&&(b.delay=0,f.reset(!1),this.resetBackoffPeriod())));c.call(h,b)};this.receive=za;var Fa=function(a){h._debug("Received",a);for(var b=0;b<a.length;++b)za(a[b])};var na=function(a,b,c){h._debug("handleFailure",
a,b,c);c.transport=a;for(a=0;a<b.length;++a){var f=b[a],d={id:f.id,successful:!1,channel:f.channel,failure:c};c.message=f;switch(f.channel){case "/meta/handshake":ka(d,{cause:"failure",action:"handshake",transport:null});break;case "/meta/connect":f=d;ba=!1;va(f,{cause:"failure",action:"retry",transport:null});break;case "/meta/disconnect":wa(d);break;case "/meta/subscribe":d.subscription=f.subscription;xa(d);break;case "/meta/unsubscribe":d.subscription=f.subscription;ya(d);break;default:la(d)}}};
...
this.configure=function(a){w.call(this,a)};this.init=function(a,b){this.configure(a);this.handshake(b)};this.handshake=function(a,b){if("disconnected"!==L)throw"Illegal state: handshaken";qa(a,b)};this.disconnect=function(a,b){if(!q()){c(a)&&(b=a,a=void 0);var f={id:""+ ++N,channel:"/meta/disconnect"};a=this._mixin(!1,{},a,f);h._putCallback(a.id,b);y("disconnecting");S([a],!1,"disconnect")}};this.startBatch=function(){++I;h._debug("Starting batch, depth",I)};this.endBatch=function(){--I;h._debug("Ending batch, depth",
I);if(0>I)throw"Calls to startBatch() and endBatch() are not paired";0!==I||q()||V||oa()};this.batch=function(a,b){a=Aa(a,b);this.startBatch();try{a.method.call(a.scope),this.endBatch()}catch(t){throw this._info("Exception during execution of batch",t),this.endBatch(),t;}};this.addListener=function(a,b,c){if(2>arguments.length)throw"Illegal arguments number: required 2, got "+arguments.length;if(!l.isString(a))throw"Illegal argument type: channel must be a string";return Ba(a,b,c,!0)};this.removeListener=
function(a){if(!(a&&a.channel&&"id"in a))throw"Invalid argument: expected subscription, not "+a;n(a)};this.clearListeners=function(){G={}};this.subscribe=function(a,b,d,e,g){if(2>arguments.length)throw"Illegal arguments number: required 2, got "+arguments.length;if(!l.isString(a))throw"Illegal argument type: channel must be a string";if(q())throw"Illegal state: disconnected";c(b)&&(g=e,e=d,d=b,b=void 0);c(e)&&(g=e,e=void 0);var f=Ba(a,b,d,!1),t={id:""+ ++N,channel:a.startsWith("/slim")?a:"/meta/subscribe",
subscription:a.startsWith("/slim")?void 0:a};t=this._mixin(!1,{},e,t);h._putCallback(t.id,g);T(t);return f};this.unsubscribe=function(a,b,d){if(1>arguments.length)throw"Illegal arguments number: required 1, got "+arguments.length;if(q())throw"Illegal state: disconnected";c(b)&&(d=b,b=void 0);this.removeListener(a);var f=a.channel,e;a:{if(e=G[f])for(var g in e)if(e.hasOwnProperty(g)&&e[g]){e=!0;break a}e=!1}e||(f={id:""+ ++N,channel:"/meta/unsubscribe",subscription:f},f=this._mixin(!1,{},b,f),h._putCallback(f.id,
d),T(f))};this.resubscribe=function(a,b){a&&!a.listener&&n(a);if(a)return this.subscribe(a.channel,a.scope,a.callback,b)};this.clearSubscriptions=function(){v()};this.publish=function(a,b,d,e){if(1>arguments.length)throw"Illegal arguments number: required 1, got "+arguments.length;if(!l.isString(a))throw"Illegal argument type: channel must be a string";if(/^\/meta\//.test(a))throw"Illegal argument: cannot publish to meta channels";if(q())throw"Illegal state: disconnected";c(b)?(e=b,b={},d=void 0):
c(d)&&(e=d,d=void 0);var f={id:""+ ++N,channel:a,data:b};f=this._mixin(!1,{},d,f);h._putCallback(f.id,e);T(f)};this.publishBinary=function(a,b,d,e,g){c(b)?(g=b,b=new ArrayBuffer(0),d=!0,e=void 0):c(d)?(g=d,d=!0,e=void 0):c(e)&&(g=e,e=void 0);this.publish(a,{meta:e,data:b,last:d},{ext:{binary:{}}},g)};this.remoteCall=function(a,b,d,e,g){if(1>arguments.length)throw"Illegal arguments number: required 1, got "+arguments.length;if(!l.isString(a))throw"Illegal argument type: target must be a string";if(q())throw"Illegal state: disconnected";
c(b)?(g=b,b={},d=r.maxNetworkDelay,e=void 0):c(d)?(g=d,d=r.maxNetworkDelay,e=void 0):c(e)&&(g=e,e=void 0);if("number"!==typeof d)throw"Illegal argument type: timeout must be a number";a.match(/^\//)||(a="/"+a);var f={id:""+ ++N,channel:"/service"+a,data:b},k=this._mixin(!1,{},e,f);f={callback:g};0<d&&(f.timeout=h.setTimeout(function(){h._debug("Timing out remote call",k,"after",d,"ms");la({id:k.id,error:"406::timeout",successful:!1,failure:{message:k,reason:"Remote Call Timeout"}})},d),h._debug("Scheduled remote call timeout",
k,"in",d,"ms"));ja[k.id]=f;T(k)};this.remoteCallBinary=function(a,b,d,e,g,h){c(b)?(h=b,b=new ArrayBuffer(0),d=!0,e=void 0,g=r.maxNetworkDelay):c(d)?(h=d,d=!0,e=void 0,g=r.maxNetworkDelay):c(e)?(h=e,e=void 0,g=r.maxNetworkDelay):c(g)&&(h=g,g=r.maxNetworkDelay);this.remoteCall(a,{meta:e,data:b,last:d},g,{ext:{binary:{}}},h)};this.getStatus=function(){return L};this.isDisconnected=q;this.setBackoffIncrement=function(a){r.backoffIncrement=a};this.getBackoffIncrement=function(){return r.backoffIncrement};
this.getBackoffPeriod=function(){return E};this.increaseBackoffPeriod=function(){E<r.maxBackoff&&(E+=r.backoffIncrement);return E};this.resetBackoffPeriod=function(){E=0};this.setLogLevel=function(a){r.logLevel=a};this.registerExtension=function(a,b){if(2>arguments.length)throw"Illegal arguments number: required 2, got "+arguments.length;if(!l.isString(a))throw"Illegal argument type: extension name must be a string";for(var d=!1,f=0;f<B.length;++f)if(B[f].name===a){d=!0;break}if(d)return this._info("Could not register extension with name",
...
function(a){for(var b=0;b<B.length;++b){var c=B[b];if(c.name===a)return c.extension}return null};this.getName=function(){return Ja};this.getClientId=function(){return P};this.getURL=function(){if(p){var a=p.getURL();if(a||(a=r.urls[p.getType()]))return a}return r.url};this.getTransport=function(){return p};this.getConfiguration=function(){return this._mixin(!0,{},r)};this.getAdvice=function(){return this._mixin(!0,{},A)};this.setTimeout=function(a,b){return J.setTimeout(function(){try{h._debug("Invoking timed function",
a),a()}catch(t){h._debug("Exception invoking timed function",a,t)}},b)};this.clearTimeout=function(a){J.clearTimeout(a)};this.registerTransport("long-polling",new O)},Transport:w,RequestTransport:D,LongPollingTransport:O,Utils:l,Z85:{encode:function(b){var d=null;b instanceof ArrayBuffer?d=b:b.buffer instanceof ArrayBuffer?d=b.buffer:Array.isArray(b)&&(d=(new Uint8Array(b)).buffer);if(null==d)throw"Cannot Z85 encode "+b;b=d.byteLength;var c=b%4;c=4-(0===c?4:c);d=new DataView(d);for(var e="",l=0,k=
0;k<b+c;++k){var m=k>=b;l=256*l+(m?0:d.getUint8(k));if(0===(k+1)%4){for(var n=52200625,v=5;0<v;--v){if(!m||v>c)e+=U[Math.floor(l/n)%85];n/=85}l=0}}return e},decode:function(b){var d=b.length%5,c=5-(0===d?5:d);for(d=0;d<c;++d)b+=U[U.length-1];d=b.length;c=new ArrayBuffer(4*d/5-c);for(var e=new DataView(c),l=0,k=0,m=0,n=0;n<d;++n){var v=b.charCodeAt(k++)-32;l=85*l+da[v];if(0===k%5){for(v=16777216;1<=v;)m<e.byteLength&&e.setUint8(m++,Math.floor(l/v)%256),v/=256;l=0}}return c}}}});
