...
const STD_ITEMS=[
    ...
    },
    {
        ...
        menu: [PLAY_ACTION, INSERT_ACTION, PLAY_SHUFFLE_ACTION, ADD_ACTION, DIVIDER, GOTO_ARTIST_ACTION, ADD_TO_FAV_ACTION, ADD_TO_PLAYLIST_ACTION, SELECT_ACTION, COPY_DETAILS_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION],
        actionMenu: [INSERT_ACTION, PLAY_SHUFFLE_ACTION, DIVIDER, GOTO_ARTIST_ACTION, ADD_TO_FAV_ACTION, ADD_TO_PLAYLIST_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION],
        searchMenu: [PLAY_ACTION, PLAY_SHUFFLE_ACTION, INSERT_ACTION, ADD_ACTION, DIVIDER, GOTO_ARTIST_ACTION, ADD_TO_FAV_ACTION, ADD_TO_PLAYLIST_ACTION, SELECT_ACTION, COPY_DETAILS_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION]
    },
    {
        command: ["playlists", "tracks"],
        params: [PLAYLIST_TRACK_TAGS], // "tags:IRad"] -> Will show rating, not album???
        menu: [PLAY_ACTION, INSERT_ACTION, PLAY_SHUFFLE_ACTION, ADD_ACTION, DIVIDER, ADD_TO_FAV_ACTION, RENAME_ACTION, REMOVE_DUPES_ACTION, DELETE_ACTION, CUSTOM_ACTIONS, SELECT_ACTION, BR_COPY_ACTION, MORE_LIB_ACTION],
        actionMenu: [INSERT_ACTION, PLAY_SHUFFLE_ACTION, DIVIDER, ADD_TO_FAV_ACTION, REMOVE_DUPES_ACTION, PLAYLIST_SORT_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION]
    },
    {
        command: ["playlists", "tracks"],
        params: [PLAYLIST_TRACK_TAGS], // "tags:IRad"] -> Will show rating, not album???
    ...
    {
        menu: [PLAY_ACTION, INSERT_ACTION, ADD_ACTION, DIVIDER, ADD_TO_PLAYLIST_ACTION, RATING_ACTION, SELECT_ACTION, COPY_DETAILS_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION],
        searchMenu: [PLAY_ACTION, INSERT_ACTION, ADD_ACTION, DIVIDER, GOTO_ARTIST_ACTION, GOTO_ALBUM_ACTION, ADD_TO_PLAYLIST_ACTION, RATING_ACTION, SELECT_ACTION, COPY_DETAILS_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION]
    },
    {
        menu: [PLAY_ACTION, PLAY_ALBUM_ACTION, PLAY_DISC_ACTION, INSERT_ACTION, ADD_ACTION, DIVIDER, ADD_TO_PLAYLIST_ACTION, RATING_ACTION, SELECT_ACTION, COPY_DETAILS_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION]
    },
    {
        menu: [PLAY_ACTION, INSERT_ACTION, PLAY_PLAYLIST_ACTION, ADD_ACTION, DIVIDER, REMOVE_ACTION, SELECT_ACTION, COPY_DETAILS_ACTION, BR_COPY_ACTION, MOVE_HERE_ACTION, CUSTOM_ACTIONS],
        largeListMenu: [PLAY_ACTION, INSERT_ACTION, PLAY_PLAYLIST_ACTION, ADD_ACTION, DIVIDER, COPY_DETAILS_ACTION, SELECT_ACTION, COPY_DETAILS_ACTION, CUSTOM_ACTIONS],
