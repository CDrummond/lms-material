...
const LMS_DEFAULT_PC_LIBRARY = "-1"; // Library ID to use for 'playlistcontrol' commands (see #882)
const LMS_DEFAULT_LIBRARIES = new Set([LMS_DEFAULT_LIBRARY, LMS_DEFAULT_PC_LIBRARY]);
