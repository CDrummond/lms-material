...
const STD_ITEMS=[
    ...
    {
        menu: [PLAY_ACTION, PLAY_ALBUM_ACTION, INSERT_ACTION, ADD_ACTION, DIVIDER, ADD_TO_PLAYLIST_ACTION, DOWNLOAD_ACTION, RATING_ACTION, SELECT_ACTION, CUSTOM_ACTIONS, MORE_LIB_ACTION]
    },
    {
