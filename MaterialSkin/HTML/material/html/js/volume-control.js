...
<v-layout row wrap :class="'vol-control-'+layout">
 ...
 <v-flex :disabled="VOL_HIDDEN==dvc" xs12>
  <v-layout>
   ...
   <v-slider :disabled="VOL_FIXED==dvc || noPlayer || queryParams.party" step="1" v-model="value" @wheel.native="wheel($event)" @click.middle="toggleMute" class="vol-slider" @start="start" @end="end" @change="changed" @selectstart.prevent="" @dragstart.prevent=""></v-slider>
