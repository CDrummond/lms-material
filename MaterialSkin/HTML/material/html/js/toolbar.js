...
<div v-if="showClock" class="toolbar-clock">
 ...
 <v-btn v-if="updateProgress.show" icon flat @click="bus.$emit('showMessage', updateProgress.text)" :title="updateProgress.text"><v-icon class="spinner">refresh</v-icon></v-btn>
